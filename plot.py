...
averages = c.execute('SELECT given_number, avg(generations) from genalgo_results WHERE roulette_method = "stochastic_acceptance_roulette" group by given_number').fetchall()
